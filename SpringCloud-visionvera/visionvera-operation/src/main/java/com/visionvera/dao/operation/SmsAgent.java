...
* @date 2017年3月29日
 */
public class SmsAgent extends Thread{
	private static final Logger logger = LogManager.getLogger(SmsAgent.class);
	
	private String phones = null;
	private String msg = null;
	
	public SmsAgent(String phones, String msg){
		this.phones = phones;
		this.msg = msg;
	}
	/**
	...
	public static int get(String phones, String msg){
		URL url = null;
		try {
			ActivitiService sms = (ActivitiService) SpringContextUtil.getBean("ActivitiService"); 
