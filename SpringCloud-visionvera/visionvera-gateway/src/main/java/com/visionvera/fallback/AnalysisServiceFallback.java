 ...
 */
@Component
public class AnalysisServiceFallback implements ZuulFallbackProvider {

	@Override
	public String getRoute() {
		return CommonConstrant.ANALYSIS_SERVICE_NAME;//统计分析系统
	}
	...
	public ClientHttpResponse fallbackResponse() {
		return new ClientHttpResponse() {
			...
			public InputStream getBody() throws IOException {
				...
				resultJson.put("errmsg", "统计分析服务不可用, 请稍后再试");
