 ...
 */
@Component
public class ResourceServiceFallback implements ZuulFallbackProvider  {

	@Override
	public String getRoute() {
		return CommonConstrant.RESOURCE_SERVICE_NAME;//静态资源服务
	}
	...
	public ClientHttpResponse fallbackResponse() {
			...
			public InputStream getBody() throws IOException {
				...
				resultJson.put("errmsg", "资源服务不可用, 请稍后再试");
