 ...
 */
@Component
public class OperationServiceFallback implements ZuulFallbackProvider  {

	@Override
	public String getRoute() {
		return CommonConstrant.OPERATION_SERVICE_NAME;//运维服务
	}
	...
	public ClientHttpResponse fallbackResponse() {
			...
			public InputStream getBody() throws IOException {
				...
				resultJson.put("errmsg", "运维服务不可用, 请稍后再试");
