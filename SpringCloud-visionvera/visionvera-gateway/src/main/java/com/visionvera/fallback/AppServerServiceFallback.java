 ...
 */
@Component
public class AppServerServiceFallback implements ZuulFallbackProvider  {

	@Override
	public String getRoute() {
		return CommonConstrant.APP_SERVICE_NAME;//移动端接口服务
	}
	...
	public ClientHttpResponse fallbackResponse() {
			...
			public InputStream getBody() throws IOException {
				...
				resultJson.put("errmsg", "移动接口服务不可用, 请稍后再试");
